    ...
    <div>
      <label className="flex bg-navy-400 hover:bg-ehe-600 p-3 text-white cursor-pointer justify-center items-center rounded-md  tracking-wide ease-linear transition-all duration-150">
        <CSVDownloader
          ...
          filename={"tableData"}
        >
          <button className="h-12 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Download full list</button>
        </CSVDownloader>
      </label>
    </div>
  );
